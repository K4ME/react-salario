...
export default class App extends Component {
  ...
  findSalarioBrutoFromLiquido() {
    ...
    const match$ = obs$.pipe(
      filter(
        currentValue => +currentValue >= +this.state.salarioLiquidoDesejado
      )
    );
        ...
        <div className="content">
          <div className="main-content">
            <LabeledInput
              ...
              currency={false}
              disabled={false}
              inputValue={this.formatSalarioBruto(
                this.state.salario.salarioBruto
              )}
          ...
          <div className="main-content">
            ...
            <div className="content-calculator">
              <button
                ...
                onClick={() => this.findSalarioBrutoFromLiquido()}
              >
